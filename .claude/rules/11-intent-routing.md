...
- When the managed-document hook injects instructions after a Read, you MUST follow those instructions before responding to the user or taking any other action. The hook output is a blocking prerequisite, not advisory context.
