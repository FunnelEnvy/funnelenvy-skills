...
- If the user intent is to create or edit a knowledge base, or asks questions about files in a knowledge base, you MUST load the KB type skill and the `kb-start` skill
