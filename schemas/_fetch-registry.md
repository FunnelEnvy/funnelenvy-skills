...
| Tag | string | Extraction quality tag: `[FULL]`, `[PARTIAL]`, `[FULL:CURL]`, `[PARTIAL:CURL]`, `[PARTIAL:TOOL]`, `[EMPTY:SPA]`, `[EMPTY:BLOCKED]`. Source suffix indicates extractor: no suffix = markdown.new, `:CURL` = curl+HTMLParser fallback, `:TOOL` = WebFetch fallback. |
