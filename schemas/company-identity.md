...
<!-- v1.1.0: Buying Triggers promoted to REQUIRED, structured format with frequency bands -->
...
> **Confidence rule:** File-level confidence in frontmatter MUST equal the minimum of all **REQUIRED** section-level confidence scores in the body. OPTIONAL sections (Company Stats, Pricing Model, Glossary, Retired Positioning, Category Gap) do not participate in the min() calculation. This is a mechanical calculation, not a judgment.
...
Events or circumstances that cause prospects to actively seek a solution.

Format per trigger:
- **Trigger:** [description of the event or circumstance]
- **Source:** [where observed -- review, Reddit, website, client-provided]
- **Frequency:** [widespread | moderate | isolated]

Common B2B trigger categories: team growth, new leadership hire, missed target, competitor action, budget cycle, regulatory change, tool sunset/acquisition/price increase, process breakdown at scale.

If no trigger events found: `[INCOMPLETE -- no trigger events identified in available sources. Interview data recommended.]`
